 ...
 * @ORM\Entity(repositoryClass="AD\CoreBundle\Repository\PensionRepository")
 * @Vich\Uploadable
 */
class Pension
{
     ...
     *
     * @ORM\OneToMany(targetEntity="AD\CoreBundle\Entity\PensionImage", mappedBy="pension", cascade={"persist","remove"}, orphanRemoval=true)
